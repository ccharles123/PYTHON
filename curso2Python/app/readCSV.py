...
#vamos a agregarlo en una lista de diccionarios para porder manipular la indformacion:

country = input("ingresar el country a consultar => ")
filterCounty = list(filter(lambda item: item["Country/Territory"] == country, data))
print(filterCounty)
